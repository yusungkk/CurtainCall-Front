...
function UserChatWindow({setActive}) {

    const defaultMessage = "상담사가 입장해야 채팅이 가능 합니다.";
    ...
    const [isEnterAdmin, setIsEnterAdmin] = useState(false);

    useEffect(() => {
        console.log(roomId);
        console.log(isEnterAdmin);
        if (!stomp && roomId === "") {
    ...
    useEffect(() => {
        ...
        setIsEnterAdmin(messages.some(msg => msg.sender === "admin"));
    }, [messages]);
                    ...
                    <div style={{display: "flex", alignItems: "center", marginTop: "10px"}}>
                        <input
                            ...
                            style={{
                                ...
                                width: "85%",
                                padding: "10px",
                                borderWidth: isEnterAdmin ? "1px" : "2px",
                                borderStyle: "solid",
                                borderColor: isEnterAdmin ? "#ddd" : "#880000",
                                color: isEnterAdmin ? "black" : "#880000",
                                borderRadius: "5px",
                                outline: "none",
                                marginRight: "6px"
                            }}
                            value={isEnterAdmin ? message : defaultMessage}
                        />
                        <SendIcon
