...
export const FIND_MESSAGES_URL = (roomId, offset = 0, limit = 20) => `${API_VERSION_V1}/chat/${roomId}?offset=${offset}&limit=${limit}`;
...
//==주문 관련 API URL==//
export const RESERVED_SEATS_URL = `${API_VERSION_V1}/orders/reserved-seats`;
export const CREATE_ORDER_URL = `${API_VERSION_V1}/orders/create`;
export const CANCEL_ORDER_URL = (id) => `${API_VERSION_V1}/orders/${id}/cancel`;
export const COMPLETE_ORDER_URL = `${API_VERSION_V1}/orders/{orderId}/complete`;
