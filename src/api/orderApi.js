...
import { RESERVED_SEATS_URL, CANCEL_ORDER_URL,
    COMPLETE_ORDER_URL, CREATE_ORDER_URL, FAIL_ORDER_URL } from "/src/utils/endpoint";
...
export const cancelOrder = async (orderId) => {
    return await fetcher(CANCEL_ORDER_URL.replace("{orderId}", orderId), {
        method: "POST",
    });
};
